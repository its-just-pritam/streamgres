...
@Slf4j
public class PriorityPartitionReader extends BasePartitionReader {


    public PriorityPartitionReader(String topicName, Integer partition, Long offset, Integer limit) {
