...
public class PriorityPartitionBuilder extends BasePartitionBuilder {

    public PriorityPartitionBuilder(String topicName, Integer count, Integer retention) {
        ...
        for(int partition=0; partition<count; ++partition) {
            ...
            String tableQuery = String.format("""
                    CREATE TABLE IF NOT EXISTS %s (
                        ...
                        PRIMARY KEY (msg_offset, priority, timestamp)
                    );
                """, partitionName);
